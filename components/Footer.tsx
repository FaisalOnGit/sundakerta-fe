      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-12 md:col-span-3 lg:col-span-4">
            ...
            <div className="text-sm text-gray-600">
              ...
              ·{" "}
              <a
                href="https://semarangkab.go.id/landing/"
                className="text-gray-600 block hover:text-gray-900 hover:underline transition duration-150 ease-in-out"
              >
                Kota Tasikmalaya
              </a>
            </div>
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-3">
            ...
            <ul className="text-sm">
              ...
              <li className="mb-2">
                <a
                  href="https://id.wikipedia.org/wiki/Sundakerta,_Sukahening,_Tasikmalaya"
                  target="_blank"
                  className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out"
                >
                  Wikipedia
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          <div className="text-sm text-gray-600 mr-4">
            &copy; KKN Sundakerta Unsil 2024. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
